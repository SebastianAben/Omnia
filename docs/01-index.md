...
| 04  | `04-system-architecture.md`       | Arsitektur cabang, pusat, sync, LLM insight, dan deployment model.            |
...
| 17  | `17-uat-polish-checklist.md`      | Checklist polish UI/UAT per role tanpa mengubah kontrak runtime.             |
...
- Checklist polish UI/UAT ditulis di `17-uat-polish-checklist.md`.
